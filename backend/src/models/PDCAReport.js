...
const deliverableStatusSchema = new mongoose.Schema(
  {
    ...
    fellowMarked: { type: Boolean, default: false },
...
const pdcaReportSchema = new mongoose.Schema(
  {
    ...
    mentorId: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: false, index: true },
    month: { type: Number, default: 1 }, // scoped to Month 1..24
