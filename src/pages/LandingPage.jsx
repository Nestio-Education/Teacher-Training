...
// TEMP: stub data until pdcaCurriculumData.js is ready — remove this once real import is restored
const UMANG_CURRICULUM_SEMESTERS = [];
...
export default function LandingPage({ onGoToLogin, onSelectRole }) {
  ...
  // Filtered Curriculum
  // TEMP: commented out real curriculum logic until pdcaCurriculumData.js is added back
  // const currentSemesterData = UMANG_CURRICULUM_SEMESTERS[selectedSemester] || UMANG_CURRICULUM_SEMESTERS[0];
  const currentSemesterData = { modules: [] };
        ...
        <div style={styles.navContainer}>
          ...
          <div style={styles.navActions}>
            <button style={styles.portalLoginBtn} onClick={onGoToLogin}>
              Login <span style={{ marginLeft: 6 }}>→</span>
            </button>
          </div>
        </div>
      </header>
